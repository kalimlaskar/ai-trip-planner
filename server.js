...
async function detectModel() {
  ...
  // Use the REST ListModels endpoint — no extra dependency needed
  try {
    ...
    // If none matched the preferred list, just use the first available text model
    ...
    console.error('Could not list models, falling back to gemini-pro:', err.message);
...
app.listen(PORT, () => {
  console.log(`✈️  Trip Planner server running at http://localhost:${PORT}`);
});
